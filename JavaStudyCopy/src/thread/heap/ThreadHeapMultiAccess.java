...
//-------------------------------------------------------------------------------------------
// public class ThreadHeapMultiAccess extends Thread 
//-------------------------------------------------------------------------------------------
public class ThreadHeapMultiAccess  {

	public static void main(String[] args) {
		
		Sum 		s	 = new Sum();		// Sum 인스턴스를 생성
		...
		System.out.println("1~100까지의 합 : " + s.getNum());		// 답 : 5050
		
		
	}

} // End - public class ThreadHeapMultiAccess extends Thread 
