...
class Id extends JFrame implements ActionListener {
	...
	//---------------------------------------------------------------------------------------
	public Id() {}
	public Id(WriteThread wt, ClientFram cf) {
		super("닉네임 입력");
		this.wt = wt;
		this.cf = cf;
	...
	static public String getId() {
		return tf.getText();		// 닉네임 입력 창에서 입력한 내용(닉네임)을 알려준다.
...
public class ClientFram extends JFrame implements ActionListener {	
			...
			// 생성자
			//----------------------------------------------------------------------------------
			public ClientFram(Socket socket) {
				super("대화 나누기");
				this.socket = socket;
